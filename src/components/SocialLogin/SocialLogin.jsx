...
const SocialLogin = () => {
    return (
        <div className="w-full">
            ...
            <button className="btn btn-ghost border-1 border-black w-full hover:border-blue-600 hover:text-blue-700 hover:bg-white mt-2"><BsGithub className='text-xl'></BsGithub>Login With Github</button>
        </div>
    );
};
